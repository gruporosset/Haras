    ...
    >
      <q-card-section>
        ...
        <div class="text-caption">
          Período: {{ formatDate(relatorio.periodo_inicio) }} a
          {{ formatDate(relatorio.periodo_fim) }}
        </div>
      </q-card-section>
          ...
          >
            <q-card-section class="text-center">
              <div class="text-h4 text-green">
                R$ {{ relatorio.custo_total.toFixed(2) }}
              </div>
          ...
          >
            <q-card-section class="text-center">
              <div class="text-h4 text-orange">
                R$ {{ relatorio.custo_medio.toFixed(2) }}
              </div>
