            ...
            <q-td :props="props">
              <div v-if="props.row.PROXIMA_AVALIACAO">
                ...
                <div
                  class="text-caption"
                  :class="
                    getClasseDiasVencimento(props.row.dias_proxima_avaliacao)
                  "
                >
...
<script setup>
  ...
  // Emits
  defineEmits(['novo-registro', 'visualizar', 'editar', 'excluir'])
  ...
  const columns = [
    ...
    {
      name: 'FERRADOR_RESPONSAVEL',
      label: 'Ferrador',
      field: 'FERRADOR_RESPONSAVEL',
      align: 'left',
    },
    {
      name: 'STATUS_CASCO',
