          ...
          <q-list>
            <q-item>
              <q-item-section avatar>
                <q-avatar v-if="animalData.FOTO_PRINCIPAL" size="80px">
                  <img :src="`http://localhost:8000${animalData.FOTO_PRINCIPAL}`" />
                </q-avatar>
                <q-icon v-else name="pets" size="80px" color="grey-5" />
              </q-item-section>
              <q-item-section>
                <q-item-label class="text-h6">{{ animalData.NOME }}</q-item-label>
                <q-item-label caption>{{ animalData.NUMERO_REGISTRO || 'Sem registro' }}</q-item-label>
                <q-item-label v-if="animalData.CHIP_IDENTIFICACAO" caption>
            ...
            <q-item>
              <q-item-section>
                ...
                <q-item-label>{{ animalData.SEXO === 'M' ? 'Macho' : 'Fêmea' }}</q-item-label>
              </q-item-section>
              <q-item-section>
            ...
            <q-item>
              <q-item-section>
                ...
                <q-item-label>{{ formatDate(animalData.DATA_NASCIMENTO) || 'Não informado' }}</q-item-label>
              </q-item-section>
              <q-item-section>
                <q-item-label caption>Pelagem</q-item-label>
                <q-item-label>{{ animalData.PELAGEM || 'Não informado' }}</q-item-label>
              </q-item-section>
            </q-item>
            ...
            <q-item v-if="animalData.CONTATO_PROPRIETARIO">
              <q-item-section>
                ...
                <q-item-label>{{ animalData.CONTATO_PROPRIETARIO }}</q-item-label>
              </q-item-section>
            </q-item>
            ...
            <q-item v-if="animalData.CPF_CNPJ_PROPRIETARIO">
              <q-item-section>
                ...
                <q-item-label>{{ animalData.CPF_CNPJ_PROPRIETARIO }}</q-item-label>
              </q-item-section>
            </q-item>
    ...
    <q-dialog v-model="genealogiaDialog" persistent>
      <q-card style="min-width: 900px; max-width: 1200px;">
        <q-card-section class="row items-center q-pb-none">
          ...
          <q-space />
          <q-btn icon="close" flat round dense @click="genealogiaDialog = false" />
        </q-card-section>
            ...
            <div class="text-center q-mb-md">
              <q-card class="animal-card q-pa-md">
                <div class="row items-center justify-center">
                  <q-avatar v-if="genealogiaData.animal.FOTO_PRINCIPAL" size="80px" class="q-mr-md">
                    <img :src="`http://localhost:8000${genealogiaData.animal.FOTO_PRINCIPAL}`" />
                  </q-avatar>
                  <q-icon v-else name="pets" size="80px" color="grey-5" class="q-mr-md" />
                  <div>
            ...
            <div class="row q-gutter-md justify-center q-mb-md">
              ...
              <div class="col-5">
                ...
                <q-card v-if="genealogiaData.pai" class="animal-card q-pa-md">
                  <div class="row items-center">
                    <q-avatar v-if="genealogiaData.pai.animal.FOTO_PRINCIPAL" size="60px" class="q-mr-sm">
                      <img :src="`http://localhost:8000${genealogiaData.pai.animal.FOTO_PRINCIPAL}`" />
                    </q-avatar>
                    <q-icon v-else name="pets" size="60px" color="grey-5" class="q-mr-sm" />
                    <div>
              ...
              <div class="col-5">
                ...
                <q-card v-if="genealogiaData.mae" class="animal-card q-pa-md">
                  <div class="row items-center">
                    <q-avatar v-if="genealogiaData.mae.animal.FOTO_PRINCIPAL" size="60px" class="q-mr-sm">
        ...
        <q-card-actions align="right">
          <q-btn flat label="Fechar" color="grey" @click="genealogiaDialog = false" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    ...
    <q-dialog v-model="fotoDialog" persistent>
      <q-card style="min-width: 400px;">
        <q-card-section class="row items-center q-pb-none">
          ...
          <q-space />
          <q-btn icon="close" flat round dense @click="fotoDialog = false" />
        </q-card-section>

        <q-card-section>
          <div class="text-center q-mb-md">
            <q-avatar size="120px" class="q-mb-md">
              <img v-if="selectedAnimal?.FOTO_PRINCIPAL" :src="`http://localhost:8000${selectedAnimal.FOTO_PRINCIPAL}`" />
        ...
        <q-card-actions align="right">
          <q-btn flat label="Cancelar" color="grey" @click="fotoDialog = false" />
          <q-btn 
            label="Enviar" 
            color="primary" 
            @click="uploadFoto"
    ...
    <q-dialog v-model="fotoViewDialog">
      <q-card style="min-width: 400px;">
        <q-card-section class="row items-center q-pb-none">
          <div class="text-h6">{{ selectedAnimal?.NOME }}</div>
          <q-space />
          <q-btn icon="close" flat round dense @click="fotoViewDialog = false" />
        </q-card-section>
        ...
        <q-card-section class="text-center">
          ...
          <div v-else class="q-pa-xl">
            <q-icon name="pets" size="120px" color="grey-5" />
