              ...
              <q-list>
                ...
                <q-item>
                  <q-item-section>
                    ...
                    <q-item-label>
                      {{ formatDate(medicaoData.DATA_MEDICAO) }}
                    </q-item-label>
                  </q-item-section>
                </q-item>
                <q-item v-if="medicaoData.dias_desde_ultima">
                  <q-item-section>
                    ...
                    <q-item-label>
                      {{ medicaoData.dias_desde_ultima }} dias
                    </q-item-label>
                  </q-item-section>
                </q-item>
              </q-list>
            ...
            <div class="col-6">
              <q-list>
                <q-item v-if="medicaoData.PESO">
                  ...
                  <q-item-section
                    side
                    v-if="medicaoData.variacao_peso"
                  >
                    <q-chip
                      :color="
                        medicaoData.variacao_peso > 0 ? 'positive' : 'negative'
                      "
                      text-color="white"
                      size="sm"
                    >
                      {{ medicaoData.variacao_peso > 0 ? '+' : ''
                      }}{{ medicaoData.variacao_peso.toFixed(1) }}
                    </q-chip>
                  </q-item-section>
                </q-item>
                <q-item v-if="medicaoData.ALTURA">
                  ...
                  <q-item-section
                    side
                    v-if="medicaoData.variacao_altura"
                  >
                    <q-chip
                      :color="
                        medicaoData.variacao_altura > 0
                          ? 'positive'
                          : 'negative'
                      "
                      text-color="white"
                    ...
                    >
                      {{ medicaoData.variacao_altura > 0 ? '+' : ''
                      }}{{ medicaoData.variacao_altura.toFixed(1) }}
                    </q-chip>
                  </q-item-section>
                </q-item>
              </q-list>
                ...
                <q-list dense>
                  <q-item v-if="medicaoData.CIRCUNFERENCIA_TORACICA">
                    <q-item-section>
                      ...
                      <q-item-label>
                        {{ medicaoData.CIRCUNFERENCIA_TORACICA }} cm
                      </q-item-label>
                    </q-item-section>
                  </q-item>
                  <q-item v-if="medicaoData.COMPRIMENTO_CORPO">
                    <q-item-section>
                      ...
                      <q-item-label>
                        {{ medicaoData.COMPRIMENTO_CORPO }} cm
                      </q-item-label>
                    </q-item-section>
                  </q-item>
                  <q-item v-if="medicaoData.CIRCUNFERENCIA_CANELA">
                    <q-item-section>
                      ...
                      <q-item-label>
                        {{ medicaoData.CIRCUNFERENCIA_CANELA }} cm
                      </q-item-label>
                    </q-item-section>
                  </q-item>
                </q-list>
                ...
                <q-list dense>
                  <q-item v-if="medicaoData.ALTURA_ANTERIOR">
                    <q-item-section>
                      ...
                      <q-item-label>
                        {{ medicaoData.ALTURA_ANTERIOR }} cm
                      </q-item-label>
                    </q-item-section>
                  </q-item>
                  <q-item v-if="medicaoData.ALTURA_POSTERIOR">
                    <q-item-section>
                      ...
                      <q-item-label>
                        {{ medicaoData.ALTURA_POSTERIOR }} cm
                      </q-item-label>
                    </q-item-section>
                  </q-item>
...
<script setup>
  ...
  const temMedidasComplementares = computed(() => {
    ...
    return (
      medicaoData.value.CIRCUNFERENCIA_TORACICA ||
