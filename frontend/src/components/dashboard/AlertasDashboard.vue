<template>
  <div id="alertas-section" class="row q-gutter-md">
    <!-- Alertas de Saúde -->
    <div class="col-12 col-md-6">
      <q-card>
        ...
        <q-card-section v-if="alertasSaude.length === 0" class="text-center text-grey">
          ...
          >
            <q-item-section avatar>
              <q-avatar 
                ...
                text-color="white"
              >
                <q-icon :name="dashboardStore.getIconeAlerta(alerta.tipo_alerta)" />
              </q-avatar>
            </q-item-section>
            ...
            <q-item-section>
              ...
              <q-item-label caption>
                <span v-if="alerta.dias_atraso > 0" class="text-negative">
    ...
    <div class="col-12 col-md-6">
      <q-card>
        ...
        <q-card-section v-if="alertasEstoque.length === 0" class="text-center text-grey">
          <q-icon name="check_circle" size="48px" color="positive" />
        ...
        <q-list v-else>
          ...
          >
            ...
            <q-item-section>
              ...
              <q-item-label v-if="alerta.dias_vencimento" caption class="text-orange">
