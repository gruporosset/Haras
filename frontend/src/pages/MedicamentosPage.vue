    ...
    <q-card>
      <q-card-section>
        ...
        >
          ...
          <q-tab name="estoque" label="Controle de Estoque" icon="inventory" />
          <q-tab name="aplicacoes" label="Aplicações" icon="medical_services" />
          <q-tab name="movimentacoes" label="Movimentações" icon="swap_horiz" />
          <q-tab name="alertas" label="Alertas" icon="warning" :badge="medicamentoStore.alertasEstoque.length || undefined" />
        ...
        <q-tab-panels v-model="activeTab" animated>
          ...
          <q-tab-panel name="aplicacoes">
            <AplicacoesMedicamentos @aplicacao-registrada="onMedicamentoSaved" />
          </q-tab-panel>
